...
var audioPlayer1 = document.getElementById("audio-control1");
var audioPlayer2 = document.getElementById("audio-control2");
var audioArray1 = ["audio/filthySoil.mp3"];
var audioArray2 = ["audio/meditation.mp3"];
var counter1 = 0;
var counter2 = 0;
audioPlayer1.addEventListener('ended', () => {
  counter++;
  if(counter1 >= audioArray.length) {
    counter1 = 0;
  }
  audioPlayer1.src = audioArray1[counter];
  audioPlayer1.play();
});
audioPlayer2.addEventListener('ended', () => {
  counter++;
  if(counter2 >= audioArray.length) {
    counter2 = 0;
  }
  audioPlayer2.src = audioArray2[counter];
  audioPlayer2.play();
});
